...
--[[
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if lockedBrickAdded == true then 
                gameState  = 'renderKey' 
            end 
            if not tier6Rendered and math.random(1, 100) <= 15 then
                b.tier = 1
                b.color = 6
                tier6Rendered = true
                renderKey = true
        ...
        if not lockedBrickAdded and b.tier == 1 and b.color == 6 then
