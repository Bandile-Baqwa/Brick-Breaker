...
function love.load()
    ...
    gFrames = {
        ...
        ['power-UpFrame'] = GenerateQuadsPowerUps(gTextures['main'])
    }
    ...
    gSounds = {
        ...
        ['power-up'] = love.audio.newSource('sounds/Powerup11.wav', 'static'),
        ['locked-Brick'] = love.audio.newSource('sounds/locked-Brick.wav', 'static'),
